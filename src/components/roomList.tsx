...
import { Button, Typography, Dialog, DialogTitle, DialogContent, TextField, Box } from '@mui/material';
                ...
                <ListItem>
                    <ListItemAvatar>
                        <div style={{ display: "flex", alignItems: "center" }}>
                            ...
                            <Button variant="contained" sx={{ marginLeft: '40px', backgroundColor: "#5964F3" }} onClick={openModal}>
                                DiscordでBotを作成する
                            </Button>
                        </div>
                    </ListItemAvatar>
